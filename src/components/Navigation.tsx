...
const Navigation = ({ isDark, toggleDarkMode }: NavigationProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-16 right-0 bottom-0 z-30 w-64 bg-white dark:bg-gray-900 shadow-xl transform transition-transform md:hidden ${
