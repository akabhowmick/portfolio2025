...
import ABPhoto from "../assets/Akash_Photo.jpg";
...
const About = () => {
  ...
  const technologies = [
    ...
    { icon: Zap, name: "Testing", color: "text-yellow-600 dark:text-yellow-400" },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-gray-800 dark:to-gray-700 flex items-center justify-center">
                <div className="text-8xl font-bold text-blue-600 dark:text-blue-400">
                  <img src={ABPhoto} alt="akash photo" />
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              I'm a passionate Full Stack Developer with expertise in building exceptional digital
              experiences. With a strong foundation in both frontend and backend technologies, I
              create seamless, user-focused applications that solve real-world problems.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {technologies.map((tech, index) => (
                <div
                  key={tech.name}
                  className={`group p-4 bg-gray-50 dark:bg-gray-800 rounded-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-2 ${
                    isVisible ? "opacity-100" : "opacity-0"
                  }`}
                  style={{ transitionDelay: `${index * 100}ms` }}
                >
                  <tech.icon
                    className={`w-8 h-8 ${tech.color} mx-auto mb-2 group-hover:scale-110 transition-transform`}
                  />
        ...
        <div>
          ...
          <div className="max-w-3xl mx-auto">
            {timeline.map((item, index) => (
              <div
                key={index}
                className={`relative pl-8 pb-12 border-l-2 border-blue-600 dark:border-blue-400 last:pb-0 transition-all duration-1000 ${
                  isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
                }`}
